  ...
  <form class="col s12 form-penjualan-barang" action="" method="post">
    <div class="row">
      <div class="input-field col s12">
        <input disabled id="disableId" name="idpenjualan" type="text" class="validate" value="<?= ($dataPenjualan['id_penjualan'] === 1) ? $dataPenjualan['id_penjualan'] : $dataPenjualan['id_penjualan'] + 1; ?>">
        <label for="disableId">ID Penjualan</label>
      </div>
    </div>
    <?php for ($i= 1; $i < 6; $i++) : ?> 
      <?php if ($i === 1) :?>
    ...
    <button class="btn light-blue darken-1 waves-effect waves-light" type="submit">Jual
